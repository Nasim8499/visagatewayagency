...
type NavTo = "/" | "/employers" | "/agencies" | "/workers" | "/documents" | "/documents/variables" | "/documents/saved" | "/documents/new";
type NavItem = {
  to: NavTo;
  label: string;
...
const navItems: NavItem[] = [
  ...
  { to: "/agencies", label: "Partner Agencies", icon: UsersRound },
  {
    to: "/documents",
    label: "Templates",
    icon: FileText,
    match: (p) => p === "/documents" || (p.startsWith("/documents/") && !["/documents/saved", "/documents/new", "/documents/variables"].includes(p)),
  },
...
// Unused icon imports retained for future use
void [Files, PenTool, QrCode, Settings, ClipboardList, Trash2];
